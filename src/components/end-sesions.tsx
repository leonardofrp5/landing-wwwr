  ...
  return (
    <div className="bg-black flex flex-col items-center justify-center p-4">
      ...
      <button
        ...
        className="flex justify-center pt-1 w-full shadow-md shadow-white/50 font-franklinDmcp uppercase bg-white text-base text-black font-bold hover:bg-gray-300 transition animate-ping-subtle-slow"
      >
        Finaliza tu corrida
      </button>
    </div>
